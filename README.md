...
Türkiye Yüzyılı Maarif Modeli'nin **resmî öğretim programları** — ilkokuldan liseye, 1-12. sınıf — makine tarafından okunabilir hâle getirildi; üzerine öğretmenin günlük işini kısaltan beş araç kuruldu. Hepsi tek bir HTML dosyasıdır: tarayıcıda çalışır, kurulum, sunucu ve üyelik istemez.
...
| 🗺️ **[Kazanım Gezgini](araclar/kazanim-gezgini.html)** | 44 dersin bütün öğrenme çıktıları, 1. sınıftan 12. sınıfa, bütün seçmeliler dahil; ders/sınıf/tema filtresi, arama, süreç bileşenleri | 2924 çıktı |
| 📋 **[Ders Planı Atölyesi](araclar/ders-plani.html)** | Tema seçince 8 ögeli plan resmî metinle dolar; düzenlenir, yazdırılır | 759 tema |
| 🕸️ **[Disiplinler Arası Harita](araclar/disiplinler-haritasi.html)** | **Ders ağı** (ağ ya da matris olarak; üstüne gelince bağlar öne çıkar, düğümler sürüklenir, "sınıfları oynat" ile ağın sınıf düzeyine göre değişimi izlenir). Her köprü temaya, tema kendi öğrenme çıktılarına, çıktı da süreç bileşenlerine kadar açılır + roller ve kapsama · **Ortak beceriler**: iki programın aynı kodu nerede çalıştığı; kod türüne göre süzülebilir (kavramsal / sosyal-duygusal / okuryazarlık / değer / eğilim) ve iki düzeyde bakılabilir — temalar (44 dersin hepsi) ya da öğrenme çıktıları (etiket yalnız 279 çıktıda var, 204'ü Türkçe) · **Yıl takvimi** · **Ara ve raporla**: bütün katmanlarda arama ve yazdırılabilir zümre raporu | 759 tema, 190 çıktı köprüsü, 100 tema geneli köprü |
| 📊 **[Beceri Gelişim Panosu](araclar/beceri-panosu.html)** | Öğrenci × süreç bileşeni izleme matrisi; sınıfın hangi bileşende takıldığını ve kimin desteğe ihtiyacı olduğunu gösterir. Veri yalnız tarayıcıda kalır, JSON olarak yedeklenir | 2924 çıktının süreç bileşenleri |
...
Kaynak: [tymm.meb.gov.tr](https://tymm.meb.gov.tr) üzerindeki resmî beceri çerçevesi sayfaları ile 54 öğretim programı PDF'i: 15 ortaokul çekirdek + seçmeli, 5 ilkokul (İlkokul Türkçe, İlkokul Matematik, Hayat Bilgisi, İnsan Hakları Vatandaşlık ve Demokrasi, Beden Eğitimi ve Oyun), sitenin program kataloğu taranarak eklenen 18 belge (Trafik Güvenliği ile Kur'an-ı Kerim, Peygamberimizin Hayatı, Afet Bilinci, Dijital Sanatlar, Düşünme Eğitimi, Geleneksel Sanatlar, Matematik ve Bilim Uygulamaları, dört Oyun ve Oyun Etkinlikleri modülü, Robotik Kodlama, Yapay Zekâ Uygulamaları, Proje Tasarımı, Spor ve Fiziki Etkinlikler, Halk Oyunları seçmelileri — Eylül 2026) ve 16 lise programı (Biyoloji, Coğrafya, Felsefe, Fizik, Kimya, Tarih, Temel Matematik, Matematik Uygulamaları ile Matematik, Görsel Sanatlar, Müzik, Din Kültürü, Beden Eğitimi, Kur'an-ı Kerim, Peygamberimizin Hayatı, İnkılap Tarihi'nin 9-12 devamları — Eylül 2026). Aynı kod dizisini süren programlar tek ders adında birleşir: Türkçe ve Matematik'in ilkokul programları ortaokuldakiyle, Matematik 9-12 ile Görsel Sanatlar 9-12 de 1-8'dekiyle aynı derstir; Fen Bilimleri 3-8 nasıl tek dersse bunlar da öyle.
...
5. **Köprüler**: bir dersin adının anıldığı cümle, tema bloğu içindeki konumuna göre sınıflandırılır. Cümle bir öğrenme çıktısının kendi uygulama metnindeyse o çıktıya bağlanır (151 çıktı, 190 bağ); temanın geneline ait bir bölümdeyse (Köprü Kurma, Ön Değerlendirme, Temel Kabuller, Farklılaştırma) hiçbir çıktıya bağlanmaz, tema düzeyinde kaydedilir (100 bağ).
...
- İngilizce programları (2-8, 9-12 ve Hazırlık) bu sürümün dışındadır: üçü de denetlendi; TYMM'nin ÖĞRENME ÇIKTILARI / SÜREÇ BİLEŞENLERİ yapısını taşımazlar ve metinleri İngilizce yazılmıştır. Almanca ve Çoklu Yabancı Dil için de aynısı geçerlidir. Türk Dili ve Edebiyatı şimdilik yalnız beceri sayımına girer: çıktı kodları sınıf bilgisi taşımaz (\"TDE1.1.1\" bir beceri etiketidir), bu yüzden gezgine eklenmedi. Okul Öncesi Eğitim Programı da dışarıdadır: ders/tema/çıktı kodu yapısı taşımaz.
...
- 759 temanın 497'sinde beş çekirdek plan ögesi eksiksiz ayrıştı (2026 seçmelilerinin çoğu kısaltılmış döngü kullanır: Temel Kabuller ve Köprü Kurma bölümleri programda hiç yok); eksik bölüm arayüzde gösterilmez.
