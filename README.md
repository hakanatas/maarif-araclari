...
| 🕸️ **[Disiplinler Arası Harita](araclar/disiplinler-haritasi.html)** | **Ders ağı** (ağ ya da matris olarak; üstüne gelince bağlar öne çıkar, düğümler sürüklenir, "sınıfları oynat" ile ağın sınıf düzeyine göre değişimi izlenir). Her köprü temaya, tema kendi öğrenme çıktılarına, çıktı da süreç bileşenlerine kadar açılır + roller ve kapsama · **Ortak beceriler**: iki programın aynı kodu nerede çalıştığı, kod türüne göre süzülebilir (kavramsal / sosyal-duygusal / okuryazarlık / değer / eğilim) · **Yıl takvimi** · **Ara ve raporla**: bütün katmanlarda arama ve yazdırılabilir zümre raporu | 274 tema, 90 çıktı köprüsü, 23 tema geneli köprü |
